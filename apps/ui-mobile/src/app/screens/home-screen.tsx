...
export const StepsIcon = () => {
	...
	return <Icon name="pin-outline" style={styles.icon} fill={theme['color-primary-default']} />;
};

export const CaloriesIcon = () => {
	const theme = useTheme();

	return <Icon name="flash-outline" style={styles.icon} fill={theme['color-danger-default']} />;
};

export const TimeIcon = () => {
	const theme = useTheme();

	return <Icon name="clock-outline" style={styles.icon} fill={theme['color-basic-700']} />;
};
...
export const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
	...
	const handleBluetoothStatusPress = () => navigation.navigate('BluetoothConnection');
			...
			<ScrollView>
				...
				<View style={styles.cardRow}>
					<View style={[styles.cardColumn, styles.leftColumn]}>
						...
						<DataCardLarge Icon={CaloriesIcon} name="Calories" quantity={1690} theme="red" />
					</View>
					<View style={[styles.cardColumn, styles.rightColumn]}>
						<View style={styles.smallCardRow}>
							<BluetoothStatus connected={!!connectedDevice} onPress={handleBluetoothStatusPress} />
